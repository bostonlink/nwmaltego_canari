...
from canari.maltego.entities import Service, IPv4Address
...
@configure(
    label='From Service to IP Dest [Netwitness]',
    description='Returns IP Dst associated with Service from Netwitness.',
    uuids=[ 'netwitness.v2.NetwitnessServiceToIPDst_Netwitness' ],
